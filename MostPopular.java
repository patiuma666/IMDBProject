...
public class MostPopular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog dialog = new ProgressDialog(MostPopular.this);
        dialog.setTitle("loading....");
        dialog.show();
        final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "http://api.themoviedb.org/3/movie/popular?api_key=8496be0b2149805afa458ab8ec27560c", null, new Response.Listener<JSONObject>() {
            @Override
        ...
        myAdapter = new UpcomingMoviesAdapter(MostPopular.this, R.layout.upcoming_movies_layout, upcomingMovieModels);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.lastmovies:
                Intent intent1 =new Intent(MostPopular.this, LatestMovies.class);
                startActivity(intent1);
                finish();

                break;
            case R.id.upcoming:
                Intent intent =new Intent(MostPopular.this,MainActivity.class);
                startActivity(intent);
                finish();
                break;

            case R.id.nowplaying:
                Intent intent2 =new Intent(MostPopular.this, NowPlaying.class);
                startActivity(intent2);
                finish();
                break;

            case R.id.toprated:
                Intent intent3 =new Intent(MostPopular.this, TopRated.class);
