...
public class LatestMovies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog dialog = new ProgressDialog(LatestMovies.this);
        dialog.setTitle("loading....");
        dialog.show();
        final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "http://api.themoviedb.org/3/movie/latest?api_key=8496be0b2149805afa458ab8ec27560c", null, new Response.Listener<JSONObject>() {
            @Override
        ...
        myAdapter = new UpcomingMoviesAdapter(LatestMovies.this, R.layout.upcoming_movies_layout, upcomingMovieModels);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.mostpopular:
                Intent intent =new Intent(LatestMovies.this, MostPopular.class);
                startActivity(intent);
                finish();
                break;

            case R.id.upcoming:
                Intent intent1 =new Intent(LatestMovies.this, MainActivity.class);
                startActivity(intent1);
                finish();

                break;
            case R.id.nowplaying:
                Intent intent2 =new Intent(LatestMovies.this, NowPlaying.class);
                startActivity(intent2);
                finish();
                break;

            case R.id.toprated:
                Intent intent3 =new Intent(LatestMovies.this, TopRated.class);
